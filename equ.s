...
OUTPORT         equ $FE95
prnxy           equ $F940
HPOSN           equ $F411       ; Positions hi-res“cursor” without plotting. 
                                ; Enter with X,Y(low,high)=horizontalposition, Accumulator = verticalposition.
...
HLIN            equ $F53A       ; Draws a line from last plot to point given.
                                ; Accumulator, X (low,high) = horizontal, Y= verticalposition.
HCOLOR          equ $F6F0       ; Sets HCOLOR to contents of X-Register(0−7).
*
************ ROM switches ************  
